...
#include "../../Status/Status.h"     //..note:: 程序返回的状态码，思想类似于bash命令的返回值

/* 宏定义 */
#define LIST_INIT_SIZE 100  // 存储空间的初始量
#define LISTINCREMENT  10   // 储存空间的分配增量

/* 顺序表元素类型定义 */
typedef int ElemType; // c语言似乎没有泛型
